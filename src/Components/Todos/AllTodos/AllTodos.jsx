...
import './AllTodos.css'
export default function AllTodos({State,dragStartHandler,drophandler,DrugOverhandler,DrugEndhandler}){
    ...
    return(
      <div className="AllTodosBox">
        <div className={State.AllTodos.length>5? "AllTodosScroll TodosBox":"AllTodos TodosBox"}>
            {State.AllTodos.map((item)=>{
                ...
                onDrop={(e)=>drophandler(e,item)} item={item}
                DeleteTodo={DeleteTodo} AddToDoneTodos={()=>AddToDoneTodos(item)}
